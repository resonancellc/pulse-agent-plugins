...
setup(
    ...
    (path + '/pulse_xmpp_agent/pluginsmachine', ['pulse_agent_plugins/machine/plugin_inventory.py', 'pulse_agent_plugins/machine/plugin_setkeypubliconauthorizedkeys.py', 'pulse_agent_plugins/common/plugin_applicationdeploymentjson.py', 'pulse_agent_plugins/common/plugin_requestinfo.py']), 
    (path + '/pulse_xmpp_agent/pluginsmachine', ['pulse_agent_plugins/common/plugin_enddeploy.py', 'pulse_agent_plugins/common/plugin_applicationdeploymentjson.py', 'pulse_agent_plugins/common/plugin_installplugin.py', 'pulse_agent_plugins/common/plugin_requestinfo.py', 'pulse_agent_plugins/common/plugin_restartbot.py', 'pulse_agent_plugins/common/plugin_shellcommand.py','pulse_agent_plugins/common/plugin_asynchromeremoteshell.py', 'pulse_agent_plugins/common/plugin_downloadfile.py', 'pulse_agent_plugins/common/plugin_enddeploy.py', 'pulse_agent_plugins/common/plugin_guacamole.py', 'pulse_agent_plugins/common/plugin_installkey.py', 'pulse_agent_plugins/common/plugin_installplugin.py', 'pulse_agent_plugins/common/plugin_installpluginscheduled.py', 'pulse_agent_plugins/common/plugin_requestinfo.py', 'pulse_agent_plugins/common/plugin_restartbot.py', 'pulse_agent_plugins/common/plugin_resultapplicationdeploymentjson.py', 'pulse_agent_plugins/common/plugin_reverse_ssh_on.py', 'pulse_agent_plugins/common/plugin_shellcommand.py']),
    ...
    (confpath, ['pulse_agent_plugins/config/inventory.ini' ])],
    entry_points={},
    extras_require={},
    install_requires=[],
    )
